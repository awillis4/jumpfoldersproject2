...
public class Student{
   ...
   private static int idCounter=1;private int studentId;private String name;private String email;public double publishedGPA;

   public Student(String name,String email,double publishedGPA){
      super();this.studentId=idCounter++;this.name=name;this.email=email;this.publishedGPA=publishedGPA;}
   ...
   public double getPublishedGPA(){
      return publishedGPA;}
   public void setPublishedGPA(double publishedGPA){this.publishedGPA=publishedGPA;}}